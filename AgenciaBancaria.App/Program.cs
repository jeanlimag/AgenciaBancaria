using Agencia_Bancaria.Dominio;
using System;
...
namespace AgenciaBancaria.App
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                // Criação da conta
                Endereço endereço = new Endereço("Rua teste", "12345678", "Pederneiras", "SP");
                Cliente cliente = new Cliente("Carla", "123456", "456789", endereço);
